...
public class ViewFundsPage extends javax.swing.JFrame {
    ...
    public ViewFundsPage(String userName) {
        ...
        initComponents();
        jButton1.addActionListener(e -> this.dispose()); // Back button
    ...
    plot.setLabelGenerator(new StandardPieSectionLabelGenerator("{0}: {1} ({2})", NumberFormat.getCurrencyInstance(), NumberFormat.getPercentInstance()));
